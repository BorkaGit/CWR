...
UCWRSettingValueDiscrete_OverallQuality::UCWRSettingValueDiscrete_OverallQuality()
{
}

void UCWRSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();

	UCWRSettingsLocal* UserSettings = UCWRSettingsLocal::Get();
...
void UCWRSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UCWRSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UCWRSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UCWRSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UCWRSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UCWRSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UCWRSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UCWRSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
