...
int32 UCWRHotfixManager::GameHotfixCounter = 0;

UCWRHotfixManager::UCWRHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UCWRHotfixManager::GetOnScreenMessages);
...
void UCWRHotfixManager::Init()
{
	Super::Init();
}

void UCWRHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		UCWRSettingsLocal* GameSettings = UCWRSettingsLocal::Get();
...
bool UCWRHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UCWRHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UCWRHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UCWRHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UCWRHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UCWRHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UCWRHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UCWRHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UCWRHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
