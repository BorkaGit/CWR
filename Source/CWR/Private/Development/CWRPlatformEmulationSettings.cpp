...
UCWRPlatformEmulationSettings::UCWRPlatformEmulationSettings()
{
}

FName UCWRPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UCWRPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UCWRPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UCWRPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UCWRPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UCWRPlatformEmulationSettings::PostInitProperties()
{
...
void UCWRPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UCWRPlatformEmulationSettings::ApplySettings()
{
...
void UCWRPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UCWRPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UCWRPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UCWRPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
