...
int32 UCWRQuickBarComponent::FindSlotIndex(const TSubclassOf<UCWRInventoryItemDefinition> ItemDef)
{
	if (ItemDef)
	{
		return static_cast<int32>( GetDefault<UCWRInventoryItemDefinition>(ItemDef)->ItemSlotType ) ;
	}

	return -1;
}

UCWRInventoryItemInstance* UCWRQuickBarComponent::GetItemAtSlot(const int32 SlotIndex)
{
...
int32 UCWRQuickBarComponent::FindBestPrioritySlotIndex()
{
