...
UCWREquipmentInstance* FCWREquipmentList::AddEntry(TSubclassOf<UCWREquipmentDefinition> EquipmentDefinition, UObject* Instigator)
{
	...
	NewEntry.Instance->SetInstigator(Instigator);
...
UCWREquipmentInstance* UCWREquipmentManagerComponent::EquipItem(TSubclassOf<UCWREquipmentDefinition> EquipmentClass, UObject* Instigator)
{
	UCWREquipmentInstance* Result = nullptr;
