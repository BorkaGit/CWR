...
FString FCWRVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FCWRVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UCWRVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UCWRVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UCWRVerbMessageHelpers::VerbMessageToCueParameters(const FCWRVerbMessage& Message)
{
...
FCWRVerbMessage UCWRVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FCWRVerbMessage Result;
