...
#include "UI/CWRActivatableWidget.h"
...
UCWRHUDLayout::UCWRHUDLayout(const FObjectInitializer& ObjectInitializer)
...
void UCWRHUDLayout::NativeOnInitialized()
{
...
void UCWRHUDLayout::NativeDestruct()
{
...
void UCWRHUDLayout::HandleEscapeAction()
{
...
void UCWRHUDLayout::HandleInputDeviceConnectionChanged(EInputDeviceConnectionState NewConnectionState, FPlatformUserId PlatformUserId, FInputDeviceId InputDeviceId)
{
...
void UCWRHUDLayout::HandleInputDevicePairingChanged(FInputDeviceId InputDeviceId, FPlatformUserId NewUserPlatformId, FPlatformUserId OldUserPlatformId)
{
	const FPlatformUserId OwningLocalPlayerId = GetOwningLocalPlayer()->GetPlatformUserId();
...
bool UCWRHUDLayout::ShouldPlatformDisplayControllerDisconnectScreen() const
{
...
void UCWRHUDLayout::NotifyControllerStateChangeForDisconnectScreen()
{
...
void UCWRHUDLayout::ProcessControllerDevicesHavingChangedForDisconnectScreen()
{
	// We should only ever get here if we have bound to the controller state change delegates
	ensure(ShouldPlatformDisplayControllerDisconnectScreen());
...
void UCWRHUDLayout::DisplayControllerDisconnectedMenu_Implementation()
{
...
void UCWRHUDLayout::HideControllerDisconnectedMenu_Implementation()
{
