...
#include "UI/Foundation/CWRActionWidget.h"
...
FSlateBrush UCWRActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UCWRActionWidget::GetEnhancedInputSubsystem() const
{
