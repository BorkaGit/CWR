...
UCWRExperienceDefinition::UCWRExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UCWRExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UCWRExperienceDefinition::UpdateAssetBundleData()
{
