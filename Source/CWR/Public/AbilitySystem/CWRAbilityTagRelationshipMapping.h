...
#include "CWRAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FCWRAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class CWR_API UCWRAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FCWRAbilityTagRelationship> AbilityTagRelationships;
};
