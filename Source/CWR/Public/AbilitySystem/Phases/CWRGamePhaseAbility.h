...
#include "CWRGamePhaseAbility.generated.h"

/**
 * UCWRGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class UCWRGamePhaseAbility : public UCWRGameplayAbility
{
	GENERATED_BODY()
	
public:

	UCWRGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "CWR|Game Phase")
