...
#include "CWRGameplayCueManager.generated.h"
...
/**
 * UCWRGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class CWR_API UCWRGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()
	
	public:
	UCWRGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UCWRGameplayCueManager* Get();
