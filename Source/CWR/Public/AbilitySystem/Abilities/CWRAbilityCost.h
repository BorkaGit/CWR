...
#include "CWRAbilityCost.generated.h"
 ...
 * UCWRAbilityCost
 *
 * Base class for costs that a CWRGameplayAbility has (e.g., ammmo or charges)
 */
UCLASS(DefaultToInstanced, EditInlineNew, Abstract)
class CWR_API UCWRAbilityCost : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CheckCost(const UCWRGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const UCWRGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
