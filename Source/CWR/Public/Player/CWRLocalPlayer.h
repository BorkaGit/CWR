...
#include "CWRLocalPlayer.generated.h"

class APlayerController;
class UInputMappingContext;
class UCWRSettingsLocal;
 ...
 */
UCLASS()
class CWR_API UCWRLocalPlayer : public UCommonLocalPlayer, public ICWRTeamAgentInterface
{
	GENERATED_BODY()
	...
	UFUNCTION()
	UCWRSettingsLocal* GetLocalSettings() const;

	/** Gets the shared setting for this player, this is read using the save game system so may not be correct until after user login */
	UFUNCTION()
	UCWRSettingsShared* GetSharedSettings() const;
...
protected:
	void OnSharedSettingsLoaded(UCWRSettingsShared* LoadedOrCreatedSettings);
...
private:
	UPROPERTY(Transient)
	mutable TObjectPtr<UCWRSettingsShared> SharedSettings;
