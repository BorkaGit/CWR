...
#include "CWRSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class CWR_API UCWRSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UCWRSettingValueDiscrete_Resolution();
