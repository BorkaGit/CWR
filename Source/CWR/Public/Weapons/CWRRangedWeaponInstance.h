...
public:	
	...
	UCWRRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	FORCEINLINE bool HasFirstShotAccuracy() const { return bHasFirstShotAccuracy; }
