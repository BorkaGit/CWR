...
#include "CWRWeaponInstance.generated.h"
 ...
 */
UCLASS()
class CWR_API UCWRWeaponInstance : public UCWREquipmentInstance
{
	GENERATED_BODY()
	
	public:
	UCWRWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	//UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	//FCWRAnimLayerSelectionSet UneuippedAnimSet;
