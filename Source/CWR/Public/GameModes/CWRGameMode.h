...
#include "CWRGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnCWRGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class ACWRGameMode : public AGameModeBase
{
	GENERATED_BODY()

public:
	ACWRGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "CWR|Pawn")
	const UCWRPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnCWRGameModePlayerInitialized OnGameModePlayerInitialized;
