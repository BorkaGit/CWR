...
public:
	...
	UCWREquipmentInstance* AddEntry(TSubclassOf<UCWREquipmentDefinition> EquipmentDefinition, UObject* Instigator = nullptr);
...
public:
	...
	UCWREquipmentInstance* EquipItem(TSubclassOf<UCWREquipmentDefinition> EquipmentDefinition, UObject* Instigator = nullptr);
