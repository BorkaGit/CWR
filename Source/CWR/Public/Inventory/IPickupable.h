...
public:
	...
	TObjectPtr<UCWRInventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(UCWRInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
