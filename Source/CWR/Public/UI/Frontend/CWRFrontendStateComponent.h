...
#include "CWRFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class CWR_API UCWRFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()
	
public:

	UCWRFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
