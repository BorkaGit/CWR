...
#include "CWRHUDLayout.generated.h"

class UCommonActivatableWidget;
class UObject;
//class UCWRControllerDisconnectedScreen;
 ...
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "CWR HUD Layout", Category = "CWR|HUD"))
class CWR_API UCWRHUDLayout : public UCWRActivatableWidget
{
	GENERATED_BODY()
	
	public:

	UCWRHUDLayout(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	*/
	...
	//TSubclassOf<UCWRControllerDisconnectedScreen> ControllerDisconnectedScreen;
