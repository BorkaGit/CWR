...
class CWR_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UCWRIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UCWRIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UCWRIndicatorManagerComponent> ManagerPtr;
