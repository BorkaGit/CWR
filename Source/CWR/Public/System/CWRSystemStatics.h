...
#include "CWRSystemStatics.generated.h"
...
UCLASS()
class UCWRSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="CWR", meta = (WorldContext = "WorldContextObject"))
