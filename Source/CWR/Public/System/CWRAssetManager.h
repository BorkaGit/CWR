...
#include "CWRAssetManagerStartupJob.h"
...
protected:
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UCWRGameData> CWRGameDataPath;
...
private:
	...
	TArray<FCWRAssetManagerStartupJob> StartupJobs;
...
template<typename AssetType>
AssetType* UCWRAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UCWRAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
